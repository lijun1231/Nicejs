...
//验证座机
    Util.checkPhone=function(sPhone) {
...
//验证手机
    Util.checkMobile=function(sMobile) {
...
//验证身份证号
    Util.checkIDCard=function(sCard) {
...
//验证姓名
    Util.checkName=function(s,notChargeLen) {
        if(notChargeLen){
...
//验证固定位数或固定范围位数的字符或数字
    Util.checkLimitCode=function(str,type,min,max,arr){
...
//页面缩放式适配
    Util.responsiveScaling=function(){
...
//下雨效果
    ...
    Util.getLocalTime=function(nS,t,hasTime){
        var t=t||".";
